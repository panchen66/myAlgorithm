...
/**
 * @Description: for study , code from  https://github.com/sunshanpeng/dark_magic.git  thanks
 * @author: chenp
 * @date: 2020/03/13 10:23
 */
...
/**
 * A class that calculates the optimal thread pool boundaries. It takes the desired target
 * utilization and the desired work queue memory consumption as input and retuns thread count and
 * work queue capacity.
 *
...
public abstract class PoolSizeCalculator {
    ...
    /**
     * Accuracy of test run. It must finish within 20ms of the testTime otherwise we retry the test.
    ...
    private void calculateOptimalCapacity(BigDecimal targetQueueSizeBytes) {
        ...
        System.out.println(
            "createTask() produced " + createTask().getClass().getName() + " which took " + mem
                + " bytes in a queue");
     ...
     * * * @param cpu *            cpu time consumed by considered task * @param wait * wait time of
     * considered task * @param targetUtilization *            target utilization of the system
     */
    ...
    /**
     * * Runs the {@link Runnable} over a period defined in {@link #elapsed}. * Based on Heinz
     * Kabbutz' ideas * (http://www.javaspecialists.eu/archive/Issue124.html). * * @param task * the
     * runnable under investigation
     */
    ...
    /**
     * Calculates the memory usage of a single element in a work queue. Based on Heinz Kabbutz'
     * ideas (http://www.javaspecialists.eu/archive/Issue029.html).
     *
    ...
    /**
     * Calculate current cpu time. Various frameworks may be used here, depending on the operating
     * system in use. (e.g. http://www.hyperic.com/products/sigar). The more accurate the CPU time
